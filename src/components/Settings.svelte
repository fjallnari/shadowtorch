...
<div class="row-span-6 col-span-full w-full h-full flex flex-col justify-start items-center gap-10 font-vt323">
    ...
    <div class="flex flex-col justify-center items-center w-11/12 gap-4">
        <div class="grid grid-cols-3 gap-2">
            {#each THEMES as theme}
                <button class="w-10 h-10 p-1 bg-accent-300 {$colorTheme === theme.id ? 'bg-clip-content border-2 border-solid': ''}" 
    ...
    <div class="flex flex-col justify-center items-center w-11/12 gap-2">
        <p class="text-center">
            Animated torch created by <a href="https://nyknck.itch.io/" title="nyknck" class="text-accent-300">@NYKNCK</a>.
        </p>
        <p class="text-center">
